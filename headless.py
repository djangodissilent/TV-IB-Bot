...
async def tick_10(c):
    print('Tick! The time for the 10 second job is: {}'.format(
...
ibc = IBC(970, gateway=True, tradingMode='paper',
          ibcIni='/home/bn/ibc/configPaper.ini')
# start and run gateway
app = Watchdog(ibc, appStartupTime=15,
               host='127.0.0.1', port=4002, clientId=11)
app.start()
